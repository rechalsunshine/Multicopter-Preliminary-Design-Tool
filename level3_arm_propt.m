function [m_arm, pr_arm, opt_geo]=level3_arm_propt(L_a)
...
optionsga=optimoptions('ga','PopulationSize',100,'MaxGenerations',30,'Display','off');
...
[geo_optga(1:6),pra_optga,exitflag] =...
    ga(@level3_armcalc_prmid,6,[],[],[],[],lbga,ubga,nonlconga,intcon,optionsga);
...
input(1)=geo_optga(1);
input(6)=geo_optga(6);
[geo_opt,pra_opt] = fmincon(@level3_armcalc_fmin,x0,A,b,[],[],lb,ub,nonlcon,optionslocal);
